...
predictor = dlib.shape_predictor('./model/shape_predictor_face_landmarks.dat')
...
cap = cv2.VideoCapture('F:/360下载软件/YawDD.rar/YawDD/YawDD dataset/Dash/Female/7-FemaleNoGlasses.mp4')
# 从视频流循环帧
while True:
